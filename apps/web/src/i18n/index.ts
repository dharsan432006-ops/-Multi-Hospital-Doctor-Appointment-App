...
const en = {
  ...
  booking: { title: 'Confirm booking', reason: 'Reason for visit (optional)', confirm: 'Confirm booking', confirmed: 'Appointment confirmed!', cancelTitle: 'Cancel appointment?', cancelOk: 'Yes, cancel', reschedule: 'Reschedule', cancelled: 'Appointment cancelled', cutoffNote: 'Free cancellation up to 2 hours before the visit.', blocked: 'Booking is blocked without Medical Care consent.', noSlot: 'No slot selected.', slotLabel: 'Slot (IST)', confirming: 'Confirming…', confirmHint: 'Your booking reference will appear here after confirmation.', statusLabel: 'Status' },
